...
public class Abfrage implements ActionListener {
	...
	ImageIcon B9 = new ImageIcon("botw.jpg");
	ImageIcon B10 = new ImageIcon("fn.jpg");
	ImageIcon B12 = new ImageIcon("cc.jpg");
	ImageIcon B13 = new ImageIcon("ll.jpg");
	ImageIcon B14 = new ImageIcon("nn.jpg");
	ImageIcon B15 = new ImageIcon("pac.png");
	ImageIcon B16 = new ImageIcon("valo.jpg");
	ImageIcon B17 = new ImageIcon("elden.jpg");
	ImageIcon B18 = new ImageIcon("fn.jpg");
	ImageIcon B19 = new ImageIcon("cc.jpg");
	ImageIcon B20 = new ImageIcon("ll.jpg");
	ImageIcon B21 = new ImageIcon("nn.jpg");
	ImageIcon B22 = new ImageIcon("pac.png");
	ImageIcon B23 = new ImageIcon("nn.jpg");
	ImageIcon B24 = new ImageIcon("pac.png");
